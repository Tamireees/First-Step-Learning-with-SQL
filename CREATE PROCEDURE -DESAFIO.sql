...
-- Mas, por outro lado, a presidência quer um relatório com dados de vendas, por datas, olhando pela perspectiva destes
-- novos departamentos.


--SELECT TP.[SABOR], SUM(INF.QUANTIDADE * INF.[PREÇO]) AS FATURAMENTO 
